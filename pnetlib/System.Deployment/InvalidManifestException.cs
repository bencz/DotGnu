/*
 * InvalidManifestException.cs - Implementation of the
 *		"System.Deployment.InvalidManifestException" class.
 *
...
public class InvalidManifestException : DeploymentException
{
	// Constructors.
	public InvalidManifestException()
		: base(S._("SD_InvalidManifest")) {}
