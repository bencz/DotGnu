/*
 * DependentPlatformMissingException.cs - Implementation of the
 *		"System.Deployment.DependentPlatformMissingException" class.
 *
...
public class DependentPlatformMissingException : DeploymentException
{
	...
	public DependentPlatformMissingException()
		: base(S._("SD_DependentPlatformMissing")) {}
...
}; // class DependentPlatformMissingException
