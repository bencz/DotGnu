...
/// <summary>
/// <para>The <see cref="T:Xsharp.KeyName"/> enumeration specifies
/// the key names that are used in key press and release events.</para>
/// </summary>
public enum KeyName
{
	None = 0x0000,
    ...
    XK_Sabovedot = 0x12bb,
    XK_ygrave = 0x12bc,
    XK_Wdiaeresis = 0x12bd,
    XK_wdiaeresis = 0x12be,
    XK_sabovedot = 0x12bf,
    XK_Wcircumflex = 0x12d0,
    XK_Tabovedot = 0x12d7,
    XK_Ycircumflex = 0x12de,
    XK_wcircumflex = 0x12f0,
    XK_tabovedot = 0x12f7,
    XK_ycircumflex = 0x12fe,
    XK_OE = 0x13bc,
    XK_oe = 0x13bd,
    ...
    XK_Farsi_8 = 0x598,
    XK_Farsi_9 = 0x599,
    XK_Arabic_percent = 0x5a5,
    XK_Arabic_superscript_alef = 0x5a6,
    XK_Arabic_tteh = 0x5a7,
    XK_Arabic_peh = 0x5a8,
    XK_Arabic_tcheh = 0x5a9,
    XK_Arabic_ddal = 0x5aa,
    XK_Arabic_rreh = 0x5ab,
    XK_Arabic_comma = 0x5ac,
    XK_Arabic_fullstop = 0x5ae,
    XK_Arabic_0 = 0x5b0,
    XK_Arabic_1 = 0x5b1,
    XK_Arabic_2 = 0x5b2,
    XK_Arabic_3 = 0x5b3,
    ...
    XK_Arabic_madda_above = 0x5f3,
    XK_Arabic_hamza_above = 0x5f4,
    XK_Arabic_hamza_below = 0x5f5,
    XK_Arabic_jeh = 0x5f6,
    XK_Arabic_veh = 0x5f7,
    XK_Arabic_keheh = 0x5f8,
    XK_Arabic_gaf = 0x5f9,
    XK_Arabic_noon_ghunna = 0x5fa,
    XK_Arabic_heh_doachashmee = 0x5fb,
    XK_Farsi_yeh = 0x5fc,
    XK_Arabic_farsi_yeh = XK_Farsi_yeh,
    XK_Arabic_yeh_baree = 0x5fd,
    XK_Arabic_heh_goal = 0x5fe,
    XK_Arabic_switch = 0xFF7E,
    XK_Cyrillic_GHE_bar = 0x680,
    XK_Cyrillic_ghe_bar = 0x690,
    XK_Cyrillic_ZHE_descender = 0x681,
    XK_Cyrillic_zhe_descender = 0x691,
    XK_Cyrillic_KA_descender = 0x682,
    XK_Cyrillic_ka_descender = 0x692,
    XK_Cyrillic_KA_vertstroke = 0x683,
    XK_Cyrillic_ka_vertstroke = 0x693,
    XK_Cyrillic_EN_descender = 0x684,
    XK_Cyrillic_en_descender = 0x694,
    XK_Cyrillic_U_straight = 0x685,
    XK_Cyrillic_u_straight = 0x695,
    XK_Cyrillic_U_straight_bar = 0x686,
    XK_Cyrillic_u_straight_bar = 0x696,
    XK_Cyrillic_HA_descender = 0x687,
    XK_Cyrillic_ha_descender = 0x697,
    XK_Cyrillic_CHE_descender = 0x688,
    XK_Cyrillic_che_descender = 0x698,
    XK_Cyrillic_CHE_vertstroke = 0x689,
    XK_Cyrillic_che_vertstroke = 0x699,
    XK_Cyrillic_SHHA = 0x68a,
    XK_Cyrillic_shha = 0x69a,
    XK_Cyrillic_SCHWA = 0x68c,
    XK_Cyrillic_schwa = 0x69c,
    XK_Cyrillic_I_macron = 0x68d,
    XK_Cyrillic_i_macron = 0x69d,
    XK_Cyrillic_O_bar = 0x68e,
    XK_Cyrillic_o_bar = 0x69e,
    XK_Cyrillic_U_macron = 0x68f,
    XK_Cyrillic_u_macron = 0x69f,
    ...
    XK_Greek_IOTAdiaeresis = XK_Greek_IOTAdieresis,
    ...
    XK_Korean_Won = 0xeff,
    XK_Armenian_eternity = 0x14a1,
    XK_Armenian_ligature_ew = 0x14a2,
    XK_Armenian_full_stop = 0x14a3,
    XK_Armenian_verjaket = 0x14a3,
    XK_Armenian_parenright = 0x14a4,
    XK_Armenian_parenleft = 0x14a5,
    XK_Armenian_guillemotright = 0x14a6,
    XK_Armenian_guillemotleft = 0x14a7,
    XK_Armenian_em_dash = 0x14a8,
    XK_Armenian_dot = 0x14a9,
    XK_Armenian_mijaket = 0x14a9,
    XK_Armenian_separation_mark = 0x14aa,
    XK_Armenian_but = 0x14aa,
    XK_Armenian_comma = 0x14ab,
    XK_Armenian_en_dash = 0x14ac,
    XK_Armenian_hyphen = 0x14ad,
    XK_Armenian_yentamna = 0x14ad,
    XK_Armenian_ellipsis = 0x14ae,
    XK_Armenian_exclam = 0x14af,
    XK_Armenian_amanak = 0x14af,
    XK_Armenian_accent = 0x14b0,
    XK_Armenian_shesht = 0x14b0,
    XK_Armenian_question = 0x14b1,
    XK_Armenian_paruyk = 0x14b1,
    XK_Armenian_AYB = 0x14b2,
    XK_Armenian_ayb = 0x14b3,
    XK_Armenian_BEN = 0x14b4,
    XK_Armenian_ben = 0x14b5,
    XK_Armenian_GIM = 0x14b6,
    XK_Armenian_gim = 0x14b7,
    XK_Armenian_DA = 0x14b8,
    XK_Armenian_da = 0x14b9,
    XK_Armenian_YECH = 0x14ba,
    XK_Armenian_yech = 0x14bb,
    XK_Armenian_ZA = 0x14bc,
    XK_Armenian_za = 0x14bd,
    XK_Armenian_E = 0x14be,
    XK_Armenian_e = 0x14bf,
    XK_Armenian_AT = 0x14c0,
    XK_Armenian_at = 0x14c1,
    XK_Armenian_TO = 0x14c2,
    XK_Armenian_to = 0x14c3,
    XK_Armenian_ZHE = 0x14c4,
    XK_Armenian_zhe = 0x14c5,
    XK_Armenian_INI = 0x14c6,
    XK_Armenian_ini = 0x14c7,
    XK_Armenian_LYUN = 0x14c8,
    XK_Armenian_lyun = 0x14c9,
    XK_Armenian_KHE = 0x14ca,
    XK_Armenian_khe = 0x14cb,
    XK_Armenian_TSA = 0x14cc,
    XK_Armenian_tsa = 0x14cd,
    XK_Armenian_KEN = 0x14ce,
    XK_Armenian_ken = 0x14cf,
    XK_Armenian_HO = 0x14d0,
    XK_Armenian_ho = 0x14d1,
    XK_Armenian_DZA = 0x14d2,
    XK_Armenian_dza = 0x14d3,
    XK_Armenian_GHAT = 0x14d4,
    XK_Armenian_ghat = 0x14d5,
    XK_Armenian_TCHE = 0x14d6,
    XK_Armenian_tche = 0x14d7,
    XK_Armenian_MEN = 0x14d8,
    XK_Armenian_men = 0x14d9,
    XK_Armenian_HI = 0x14da,
    XK_Armenian_hi = 0x14db,
    XK_Armenian_NU = 0x14dc,
    XK_Armenian_nu = 0x14dd,
    XK_Armenian_SHA = 0x14de,
    XK_Armenian_sha = 0x14df,
    XK_Armenian_VO = 0x14e0,
    XK_Armenian_vo = 0x14e1,
    XK_Armenian_CHA = 0x14e2,
    XK_Armenian_cha = 0x14e3,
    XK_Armenian_PE = 0x14e4,
    XK_Armenian_pe = 0x14e5,
    XK_Armenian_JE = 0x14e6,
    XK_Armenian_je = 0x14e7,
    XK_Armenian_RA = 0x14e8,
    XK_Armenian_ra = 0x14e9,
    XK_Armenian_SE = 0x14ea,
    XK_Armenian_se = 0x14eb,
    XK_Armenian_VEV = 0x14ec,
    XK_Armenian_vev = 0x14ed,
    XK_Armenian_TYUN = 0x14ee,
    XK_Armenian_tyun = 0x14ef,
    XK_Armenian_RE = 0x14f0,
    XK_Armenian_re = 0x14f1,
    XK_Armenian_TSO = 0x14f2,
    XK_Armenian_tso = 0x14f3,
    XK_Armenian_VYUN = 0x14f4,
    XK_Armenian_vyun = 0x14f5,
    XK_Armenian_PYUR = 0x14f6,
    XK_Armenian_pyur = 0x14f7,
    XK_Armenian_KE = 0x14f8,
    XK_Armenian_ke = 0x14f9,
    XK_Armenian_O = 0x14fa,
    XK_Armenian_o = 0x14fb,
    XK_Armenian_FE = 0x14fc,
    XK_Armenian_fe = 0x14fd,
    XK_Armenian_apostrophe = 0x14fe,
    XK_Armenian_section_sign = 0x14ff,
    XK_Georgian_an = 0x15d0,
    XK_Georgian_ban = 0x15d1,
    XK_Georgian_gan = 0x15d2,
    XK_Georgian_don = 0x15d3,
    XK_Georgian_en = 0x15d4,
    XK_Georgian_vin = 0x15d5,
    XK_Georgian_zen = 0x15d6,
    XK_Georgian_tan = 0x15d7,
    XK_Georgian_in = 0x15d8,
    XK_Georgian_kan = 0x15d9,
    XK_Georgian_las = 0x15da,
    XK_Georgian_man = 0x15db,
    XK_Georgian_nar = 0x15dc,
    XK_Georgian_on = 0x15dd,
    XK_Georgian_par = 0x15de,
    XK_Georgian_zhar = 0x15df,
    XK_Georgian_rae = 0x15e0,
    XK_Georgian_san = 0x15e1,
    XK_Georgian_tar = 0x15e2,
    XK_Georgian_un = 0x15e3,
    XK_Georgian_phar = 0x15e4,
    XK_Georgian_khar = 0x15e5,
    XK_Georgian_ghan = 0x15e6,
    XK_Georgian_qar = 0x15e7,
    XK_Georgian_shin = 0x15e8,
    XK_Georgian_chin = 0x15e9,
    XK_Georgian_can = 0x15ea,
    XK_Georgian_jil = 0x15eb,
    XK_Georgian_cil = 0x15ec,
    XK_Georgian_char = 0x15ed,
    XK_Georgian_xan = 0x15ee,
    XK_Georgian_jhan = 0x15ef,
    XK_Georgian_hae = 0x15f0,
    XK_Georgian_he = 0x15f1,
    XK_Georgian_hie = 0x15f2,
    XK_Georgian_we = 0x15f3,
    XK_Georgian_har = 0x15f4,
    XK_Georgian_hoe = 0x15f5,
    XK_Georgian_fi = 0x15f6,
    XK_Ccedillaabovedot = 0x16a2,
    XK_Xabovedot = 0x16a3,
    XK_Qabovedot = 0x16a5,
    XK_Ibreve = 0x16a6,
    XK_IE = 0x16a7,
    ...
    XK_schwa = 0x16f6,
    XK_Lbelowdot = 0x16d1,
    XK_Lstrokebelowdot = 0x16d2,
    XK_lbelowdot = 0x16e1,
    XK_lstrokebelowdot = 0x16e2,
    XK_Gtilde = 0x16d3,
    XK_gtilde = 0x16e3,
    XK_Abelowdot = 0x1ea0,
    XK_abelowdot = 0x1ea1,
    XK_Ahook = 0x1ea2,
    XK_ahook = 0x1ea3,
    XK_Acircumflexacute = 0x1ea4,
    XK_acircumflexacute = 0x1ea5,
    XK_Acircumflexgrave = 0x1ea6,
    XK_acircumflexgrave = 0x1ea7,
    XK_Acircumflexhook = 0x1ea8,
    XK_acircumflexhook = 0x1ea9,
    XK_Acircumflextilde = 0x1eaa,
    XK_acircumflextilde = 0x1eab,
    XK_Acircumflexbelowdot = 0x1eac,
    XK_acircumflexbelowdot = 0x1ead,
    XK_Abreveacute = 0x1eae,
    XK_abreveacute = 0x1eaf,
    XK_Abrevegrave = 0x1eb0,
    XK_abrevegrave = 0x1eb1,
    XK_Abrevehook = 0x1eb2,
    XK_abrevehook = 0x1eb3,
    XK_Abrevetilde = 0x1eb4,
    XK_abrevetilde = 0x1eb5,
    XK_Abrevebelowdot = 0x1eb6,
    XK_abrevebelowdot = 0x1eb7,
    XK_Ebelowdot = 0x1eb8,
    XK_ebelowdot = 0x1eb9,
    XK_Ehook = 0x1eba,
    XK_ehook = 0x1ebb,
    XK_Etilde = 0x1ebc,
    XK_etilde = 0x1ebd,
    XK_Ecircumflexacute = 0x1ebe,
    XK_ecircumflexacute = 0x1ebf,
    XK_Ecircumflexgrave = 0x1ec0,
    XK_ecircumflexgrave = 0x1ec1,
    XK_Ecircumflexhook = 0x1ec2,
    XK_ecircumflexhook = 0x1ec3,
    XK_Ecircumflextilde = 0x1ec4,
    XK_ecircumflextilde = 0x1ec5,
    XK_Ecircumflexbelowdot = 0x1ec6,
    XK_ecircumflexbelowdot = 0x1ec7,
    XK_Ihook = 0x1ec8,
    XK_ihook = 0x1ec9,
    XK_Ibelowdot = 0x1eca,
    XK_ibelowdot = 0x1ecb,
    ...
    XK_Ohook = 0x1ece,
    XK_ohook = 0x1ecf,
    XK_Ocircumflexacute = 0x1ed0,
    XK_ocircumflexacute = 0x1ed1,
    XK_Ocircumflexgrave = 0x1ed2,
    XK_ocircumflexgrave = 0x1ed3,
    XK_Ocircumflexhook = 0x1ed4,
    XK_ocircumflexhook = 0x1ed5,
    XK_Ocircumflextilde = 0x1ed6,
    XK_ocircumflextilde = 0x1ed7,
    XK_Ocircumflexbelowdot = 0x1ed8,
    XK_ocircumflexbelowdot = 0x1ed9,
    XK_Ohornacute = 0x1eda,
    XK_ohornacute = 0x1edb,
    XK_Ohorngrave = 0x1edc,
    XK_ohorngrave = 0x1edd,
    XK_Ohornhook = 0x1ede,
    XK_ohornhook = 0x1edf,
    XK_Ohorntilde = 0x1ee0,
    XK_ohorntilde = 0x1ee1,
    XK_Ohornbelowdot = 0x1ee2,
    XK_ohornbelowdot = 0x1ee3,
    XK_Ubelowdot = 0x1ee4,
    XK_ubelowdot = 0x1ee5,
    XK_Uhook = 0x1ee6,
    XK_uhook = 0x1ee7,
    XK_Uhornacute = 0x1ee8,
    XK_uhornacute = 0x1ee9,
    XK_Uhorngrave = 0x1eea,
    XK_uhorngrave = 0x1eeb,
    XK_Uhornhook = 0x1eec,
    XK_uhornhook = 0x1eed,
    XK_Uhorntilde = 0x1eee,
    XK_uhorntilde = 0x1eef,
    XK_Uhornbelowdot = 0x1ef0,
    XK_uhornbelowdot = 0x1ef1,
    XK_Ybelowdot = 0x1ef4,
    XK_ybelowdot = 0x1ef5,
    XK_Yhook = 0x1ef6,
    XK_yhook = 0x1ef7,
    ...
    XK_Uhorn = 0x1efc,
    XK_uhorn = 0x1efd,
    XK_combining_tilde = 0x1e9f,
    XK_combining_grave = 0x1ef2,
