...
enum Tokens {
	TokenNULL,			// placeholder, used to do loop in line parsing
	...
	TokenCOMMENTEND,	// end of comment (*/ if C comment, newline if C++ comment)
	TokenTEXT,			// text that is not keyword or quoted string
	TokenSTRING,		// quoted string
	TokenNAMESPACE,	// start of namespace declaration (for csdoc)
	TokenCLASS,			// start of class declaration (for csdoc)
